...
public class VehiclesOfInterestController {
    ...
    */  
     ...
     */
    {
        try
        {
          //PreparedStatement pstmt = conn.prepareStatement("update vehicle_of_interest set reason = ?, make = ?, model = ?, veh_year = ?, color = ?,owners_name = ?, owners_phone = ? where license_plate =?");
